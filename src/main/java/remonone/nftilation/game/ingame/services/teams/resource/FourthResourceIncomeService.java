...
public class FourthResourceIncomeService implements IPurchasableService {
    ...
    public void OnPurchase(Player buyer, int price) {
        ...
        Double requiredValue = (Double) NestedObjectFetcher.getNestedObject(MetaConstants.META_UPGRADES_RESOURCE, MetaConfig.getInstance().getUpgrades(), 2);
        ...
        Double nextLevelValue = (Double) NestedObjectFetcher.getNestedObject(MetaConstants.META_UPGRADES_RESOURCE, MetaConfig.getInstance().getUpgrades(), 3);
