...
public class ThirdUtilityService implements IPurchasableService {
    @Override
    public String getServiceName() {
        return "third-utility-service";
    }
    ...
    public void OnPurchase(Player buyer, int price) {
        ...
        team.getParameters().put(PropertyConstant.TEAM_UTILITY_ITEM_LEVEL, 3);
        ...
        team.getPlayers().forEach(playerModel -> {
            ...
            player.sendMessage(ChatColor.WHITE + playerName + ChatColor.GOLD + MessageConstant.TEAM_UPGRADE + MessageConstant.TEAM_UPGRADE_UTILITY + " " + 2);
